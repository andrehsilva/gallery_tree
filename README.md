...
## Sobre o Projeto
Este projeto consiste em uma galeria interativa de livros desenvolvida utilizando o framework [Streamlit](https://streamlit.io/). A aplicação permite explorar uma coleção de livros por meio de filtros dinâmicos e intuitivos, exibindo os resultados em um layout organizado de cards.
...
## Contribuindo
Contribuições são bem-vindas! Sinta-se à vontade para abrir uma [issue](https://github.com/seu-usuario/nome-do-repositorio/issues) ou enviar um pull request.
