...
if titulo_input or volume_input or disciplina_input or serie_input:
    ...
    st.write("Nenhum filtro aplicado. Por favor, selecione pelo menos um filtro para exibir os resultados.")